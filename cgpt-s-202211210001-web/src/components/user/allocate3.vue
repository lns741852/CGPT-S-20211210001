  ...
  <div id="printContent"  style="width: 100%">
    ...
    <el-card style="margin-top: 10px">
      <el-table class="tablePrint" :data="allocatePrint.reqdetails">
        <el-table-column prop="setno" label="盤包代號"  width="100"> </el-table-column>
        <el-table-column prop="setname" label="盤包名稱" width="180"> </el-table-column>
        <el-table-column prop="setcount" label="申領數量" width="100"> </el-table-column>
        <el-table-column prop="realcount" label="配送數量" width="100"> </el-table-column>
        <el-table-column label="條碼編號">
          <template #default="scope">
                <li class="tableBarcode" v-for="item in scope.row.barcodeName" :key="item">
                    {{item.barcode}}
                </li>
          </template>
        </el-table-column>
