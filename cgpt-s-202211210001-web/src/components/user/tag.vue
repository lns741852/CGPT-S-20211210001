      ...
      <template #default>
        ...
        >
          ...
          <el-form-item label="盤包代號：">
            <el-form :rules="addFormRules">
              <el-row gutter="24">
                ...
                <el-col :span="5"
                  ><el-input v-model="inputData.sn" placeholder="序號"
                /></el-col>
                <el-col :span="5"
                  ><el-input v-model="inputData.num" placeholder="數量"
                /></el-col>
                <el-col class="Edit_setno_font" :span="3">
                  <router-link to="/setno_search" target="_blank">查詢盤包代號</router-link>
                </el-col>
              </el-row>
            </el-form>
          </el-form-item>
          <el-form-item label="消毒鍋：" prop="disinfection">
            <el-select
              v-model="inputData.disinfection"
              placeholder="請選擇"
